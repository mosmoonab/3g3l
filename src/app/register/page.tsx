...
import { UserPlus, Mail, Lock, User, Fingerprint } from 'lucide-react';
      ...
      <main className="relative z-10 flex-grow flex items-center justify-center py-24 px-4">
        <div className="max-w-md w-full bg-black/20 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-lg text-center">
          <div className="mb-8">
            ...
            <p className="text-white/70">Create your 3G3L account</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="relative">
              <Fingerprint className="absolute left-3 top-1/2 -translate-y-1/2 text-white/60" />
              <Input
                type="text"
